...
Comparison is against the same studio's own historical baseline (2022–2023 peak performance), measured on a matched product category.
...
## Honest gaps relative to the JD

Three areas where this repo does not directly demonstrate JD requirements:

- **Outsourcing and vendor management.** The studio's model was fully in-house. Vendor relationships, quality review, and outsourcing pilots are not in my recent work. This is the gap I would most want to address proactively in the first six months.
- **Multi-team scope.** This work was for a single studio team. Coordinating across multiple design sub-teams is a step up in scope, and I would expect a learning curve in the first quarter.
- **Design-specific tooling.** I have not used Figma, YouTrack, or Coverbaker in production. I am familiar with comparable systems (Sheets-as-coordination-layer, ticket queues, asset management) and would expect to reach working competence in the standard tools quickly, but I would not claim existing fluency.

Naming these is not a rhetorical move. They are real gaps and shape what the first three to six months would honestly look like.
